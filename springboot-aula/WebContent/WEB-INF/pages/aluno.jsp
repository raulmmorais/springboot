		...
		<div id="form_incluir" style="display: none">
			<form id="formCadastrar">
				<div class="form-group row">
					...
					<label for="dtNascimento" class="col-sm-2 col-form-label">Data de nascimento</label>
					<div class="col-sm-3">
						<input type='text' class="form-control datepicker" name='dtNascimento' id='dtNascimento' />
					</div>
